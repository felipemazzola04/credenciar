...
return [
    ...
    [ // $staticRoutes
        '/api/contas' => [
            [['_route' => 'conta_index', '_controller' => 'App\\Controller\\ApiController::index'], null, ['GET' => 0], null, false, false, null],
            [['_route' => 'conta_create', '_controller' => 'App\\Controller\\ApiController::create'], null, ['POST' => 0], null, false, false, null],
        ],
    ...
    [ // $dynamicRoutes
        39 => [
            [['_route' => 'conta_contas', '_controller' => 'App\\Controller\\ApiController::contas'], ['credencial', 'chave'], ['GET' => 0], null, false, true, null],
            [['_route' => 'conta_delete', '_controller' => 'App\\Controller\\ApiController::delete'], ['credencial', 'chave'], ['DELETE' => 0], null, false, true, null],
        ],
        78 => [[['_route' => '_preview_error', '_controller' => 'error_controller::preview', '_format' => 'html'], ['code', '_format'], null, null, false, true, null]],
